// this file is not used, kept for reference:
...
extension String {
    ...
    // no longer used after switching to decoder.dateDecodingStrategy in NetworkManager.swift, kept for reference:
    
    func convertToDate() -> Date? {
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = "yyyy-MM-dd'T'HH:mm:ssZ" //https://www.nsdateformatter.com
    ...
    func convertToDisplayFormat() -> String {
        guard let date = self.convertToDate() else { return "unknown time" }
